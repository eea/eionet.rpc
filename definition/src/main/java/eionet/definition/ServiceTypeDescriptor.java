 ...
 * XML Schema.
 * $Id: ServiceTypeDescriptor.java,v 1.1 2003/04/24 12:58:32 te-ee Exp $
 */
...
public class ServiceTypeDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public ServiceTypeDescriptor() {
        ...
        //-- _methods
        desc = new XMLFieldDescriptorImpl(Methods.class, "_methods", "Methods", NodeType.Element);
        handler = (new XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    ServiceType target = (ServiceType) object;
                    target.setMethods( (Methods) value);
                }
                catch (Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
    ...
    } //-- eionet.definition.ServiceTypeDescriptor()
    ...
    **/
    ...
    {
        return eionet.definition.ServiceType.class;
